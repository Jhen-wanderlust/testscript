...
emp();
  ...
  setTimeout( () =>
    ...
    { 
            ...
            setTimeout(() => 
                          ...
                          { 
                             document.querySelector("#txt_wardsc").value = listData[0];
  ...
  ware();
    ...
    let getRand = localStorage.getItem("getRandom");
      ...
      let  listData = [ //Item Code (50 char.)
                'ITM99',
                'ITM100',
                'ITM200',
                'ITM252',
                                ...
                                listExistngData.forEach((data) => 
                                  {
                                            ...
                                            listData.includes(data) ?   document.querySelectorAll('.ui-button.ui-widget.ui-state-default.ui-corner-all.ui-button-text-only')[2].click() : document.querySelector("#txt_info_itmdsc").value = listData[0];
                                  })
...
item_name();
  ...
  localStorage.setItem("getRandom8", 0);
  ...
  let getRand8 = localStorage.getItem("getRandom8");
           ...
           let  listData1 = [ //Item Type
                              ...
                              'INVENTORY'
                                    ...
                                    let  listData8 = [ // Re-order Level
                                          ...
                                          document.querySelector("#txt_info_itmtyp").value = listData1[0];
                                          document.querySelector("#txt_info_itmclacde").value = listData2[0];
                                          document.querySelector("#txt_info_brncde").value = listData3[0];
                                          document.querySelector("#txt_info_warcde").value = listData4[0];
                                                setTimeout(() => 
                                                ...
                                                { 
                                                document.querySelector("#txt_info_untmea1").value  = listData5[0];
                                                document.querySelector("#txt_info_untcst").value  = listData6[0];
                                                document.querySelector("#txt_info_untprc").value  = listData7[0];
                                                document.querySelector("#txt_info_crilvl").value  = listData8[0];
                                                                      ...
                                                                      document.getElementsByName('btnsave')[0].click();
                                                                        ...
                                                                        setTimeout(() => 
                                                                                  ...
                                                                                  document.querySelector('.ajs-button.print').click();
                                                                                    ...
                                                                                    localStorage.setItem("getRandom7", parseInt(getRand8) + 1);
                                                                                  },2000)
                                                                      },2000)
